...
使用 `crt-static` 可以避免干净 Windows 环境缺少 `VCRUNTIME140.dll` 等 VC++ 运行库。2026-06-14 的 `0.1.6` x86-64 Windows host 产物已在维护者本机的 Windows VM 中完成协议 v4 实机 E2E；验证记录见 [v0.1.6 E2E 测试报告](e2e-v0.1.6.md)。
